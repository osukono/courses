...
//        });
        ...
        Route::middleware('permission:' . Permissions::update_content)->group(function () {
            ...
            Route::patch('content/exercise/fields/{exerciseField}/audio/duration', 'ExerciseFieldController@duration')->name('admin.exercise.fields.audio.duration');
        ...
        Route::middleware('permission:' . Permissions::update_translations)->group(function() {
            ...
            Route::patch('translations/{translation}/audio/duration', 'TranslationController@duration')->name('admin.translations.audio.duration');
