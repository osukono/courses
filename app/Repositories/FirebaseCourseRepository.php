    ...
    public static function findOrCreate(Course $course): DocumentReference
    {
        ...
        return $firestore->collection(Firebase::courses_collection)
            ->add([
                ...
                'image' => $course->image,
                'android_product_id' => $course->android_product_id,
                'ios_product_id' => $course->ios_product_id,
                'ad_mob_banner_unit_id_android' => $course->ad_mob_banner_unit_id_android,
                'ad_mob_banner_unit_id_ios' => $course->ad_mob_banner_unit_id_ios,
