    ...
    'index' => [
        ...
        'section' => [
            'top' => [
                ...
                'text' => "Yummy Lingo provides you with a powerful method of learning languages with audio courses.",
                'button' => 'Learn more'
            ],
            'app' => [
                ...
                'description' => "<p>Download the app and get access to the courses developed by the most experienced teachers we can offer.</p>" .
                    ...
                    "<p>The application built as a player in mind. You can either follow the material you are listening to or just simply use it as an audio player learning new languages while driving, doing sports and more.</p>",
                'links' => [
