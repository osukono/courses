    ...
    <div class="card shadow-sm">
        <div class="card-body">
            ...
            <form action="{{ route('admin.languages.update', $language) }}" method="post" autocomplete="off">
                ...
                @textarea(['name' => 'capitalized_words', 'label' => 'Capitalized Words', 'rows' => 5, 'default' => $language->capitalized_words, 'helper' => 'List of capitalized words separated with comma'])
