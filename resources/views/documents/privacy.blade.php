...
@section('content')
    <div class="container mb-5">
        ...
        <p>
            Yummy Lingo built the Yummy Lingo app as a Commercial app. This SERVICE is provided by Yummy Lingo and is
        ...
        <p>
            ...
            identifiable information, including but not limited to email address, name. The information that we request
